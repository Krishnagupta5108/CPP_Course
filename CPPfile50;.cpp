...
public:
    ...
    virtual void display() = 0 ; // do nothing function  // pure virtual function now from here next any class is made with inheriting this class its re*uried to made a display function.
};
