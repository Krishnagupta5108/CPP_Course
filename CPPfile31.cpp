...
class number {
    ...
    number  ( ) {
        // count++ ; 
        cout<<"The is the time when the constructor for object number"<<count<<" is called "<<endl; 
    }
    
//   Formation of the Destructor ***********************************    
    ~number  ( ) {
        cout<<"The is the time when the Destructor  for object number"<<count<<" is called "<<endl; 
        // count-- ; 
    }
